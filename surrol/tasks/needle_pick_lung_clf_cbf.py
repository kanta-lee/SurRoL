...
class NeedlePickLungCLF(PsmEnv):
    ...
    def _env_setup(self):
        ...
        self.cylinder_offset = np.array([0.0, 0.04, -0.03]) # 用于 sample_goal 里的偏移
        ...
        self.obstacle_radius = 0.003 * self.SCALING  # 半径 (大约 1.5cm * 缩放)
        self.obstacle_offset = np.array([0.0, -0.01, 0.02]) * self.SCALING 
        ...
        self.obstacle_id = p.createMultiBody(
            ...
            baseVisualShapeIndex=p.createVisualShape(
                ...
                rgbaColor=[0, 1, 1, 1]  # 青色 (Cyan) [R, G, B, Alpha]
            ),
