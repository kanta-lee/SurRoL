...
from skill_chaining.components.envrionment import MatchBoardSLWrapper
...
parser.add_argument('--subtask', type=str,
                    help='how many steps allowed to run', default='draw')
...
def main():
    ...
    num_itr = 200 if not args.video else 5
    cnt = 0
    success_counter = 0
